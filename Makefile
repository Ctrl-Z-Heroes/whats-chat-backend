...
_run-connector: export OTEL_CONFIG_SRC = ./docker/otel-collector/otel-collector-config-connector.yml
...
run-dev-processor: export OTEL_CONFIG_SRC = ./docker/otel-collector/otel-collector-config-processor.yml
run-dev-processor:
	docker compose -f docker-compose.yml up
